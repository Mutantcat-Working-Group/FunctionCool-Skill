...
2. `bash ~/.claude/skills/functioncool/scripts/query.sh "merge sort" "PYTHON"`
...
Place this directory at `~/.claude/skills/functioncool/`. The skill is auto-discovered. The script path in this skill body assumes the standard install location; if you move it, update the `bash` invocation.
